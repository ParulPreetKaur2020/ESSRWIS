...
def atmospheric_data():
     ...
     #postgres_insert_queryess ="""INSERT INTO public."RWIS"("ObjectId", "Status", "WIND_DIRECTION", "PRECIPITATION_TYPE", "PRECIPITATION_INTENSITY", "RPUID", "TOWNSHIP", "SECTION", "RANGE", "SITE_NUMBER", "RPUID_NAME", "NWS_ID", "LATITUDE", "LONGITUDE", "GPS_ALTITUDE", "COUNTY_NAME", "ROUTE_NAME", "MILE_POST", "GARAGE_NAME", "COUNTY_NO", "COST_CENTER", "DISTRICT_NO", "AIR_TEMP", "RELATIVE_HUMIDITY", "DEW_POINT", "VISIBILITY", "AVG_WINDSPEED_MPH", "MAX_WINDSPEED_MPH", "AVG_WINDSPEED_KNOTS", "MAX_WINDSPEED_KNOTS", "WIND_DIRECTION_DEG", "PRECIPITATION_RATE", "PRECIPITATION_ACCUMULATION", "SENSOR_ID", "ROUTE_ID", "ROUTE_MEASURE", "UTC_OFFSET","DATA_LAST_UPDATED", "REST_LAST_UPDATED","Surface_Condition","Surface_temp") VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)""";
     #recordess_to_insert =(ObjectId, Status, WindDirection, Precipitationtype, PrecipitationIntensity,RPUID,Township,SECTION,RANGE,SITE_NUMBER, RPUID_NAME,NWS_ID,LATITUDE,LONGITUDE,GPS_ALTITUDE,COUNTY_NAME,ROUTE_NAME,MILE_POST,GARAGE_NAME,COUNTY_NO,COST_CENTER,DISTRICT_NO,AIR_TEMP,RELATIVE_HUMIDITY,DEW_POINT,VISIBILITY,AVG_WINDSPEED_MPH,MAX_WINDSPEED_MPH,AVG_WINDSPEED_KNOTS,MAX_WINDSPEED_KNOTS,WIND_DIRECTION_DEG,PRECIPITATION_RATE,PRECIPITATION_ACCUMULATION,SENSOR_ID,ROUTE_ID,ROUTE_MEASURE,UTC_OFFSET,DATA_LAST_UPDATED,REST_LAST_UPDATED,Surface_Condition,Surface_temp)
     recordess_to_update = (Status, WindDirection, Precipitationtype, PrecipitationIntensity, RPUID, Township, SECTION, RANGE, SITE_NUMBER, RPUID_NAME, NWS_ID, LATITUDE, LONGITUDE, GPS_ALTITUDE, COUNTY_NAME, ROUTE_NAME, MILE_POST, GARAGE_NAME, COUNTY_NO, COST_CENTER, DISTRICT_NO, AIR_TEMP, RELATIVE_HUMIDITY, DEW_POINT, VISIBILITY,AVG_WINDSPEED_MPH, MAX_WINDSPEED_MPH, AVG_WINDSPEED_KNOTS, MAX_WINDSPEED_KNOTS, WIND_DIRECTION_DEG,PRECIPITATION_RATE, PRECIPITATION_ACCUMULATION, SENSOR_ID, ROUTE_ID, ROUTE_MEASURE, UTC_OFFSET, DATA_LAST_UPDATED,REST_LAST_UPDATED,Surface_Condition,Surface_temp,ObjectId)
     cursor.execute(postgres_update_queryess, recordess_to_update)
     #cursor.execute(postgres_insert_queryess, recordess_to_insert)
     connection.commit()
     count = cursor.rowcount
     print(count, "Record inserted successfully into RWIS table")
